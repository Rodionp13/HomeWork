 ...
 */
let takingShower = 15
let makingBreakfast = 15
let timeForTakingBreakfast = 10
let watchingTV = 20
let takingClothes = 5
let brushTeeth = 3

let totalActivityTime = takingShower + makingBreakfast + timeForTakingBreakfast +  watchingTV + takingClothes + brushTeeth
...
let thingsNeedToBeDone = takingShower + makingBreakfast + timeForTakingBreakfast + takingClothes + brushTeeth
let thingsLikeToDo = watchingTV
...
*/
let timeForJogging = 15
let timeForIdealMorning = totalActivityTime - thingsLikeToDo + timeForJogging
